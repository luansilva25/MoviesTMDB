...
async function Nextpage(Nextpage){
    page.value = Nextpage
    await MovieStore.GetAllMovies(`discover/movie?api_key=e7d4b6a6fbebc495912044d6d4cc5a13&language=pt-BR&with_companies=1|2|3|420|7521&sort_by=popularity.desc&page=${page.value}`)
}
